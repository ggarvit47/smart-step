...
const UpdateScoreMatch = ({ slug, university, scoreData, closeRef, fetchScoreMatch }) => {

    const dispatch = useDispatch();

    const activeStep = useSelector(state => state.university.activeStep);

    const [disciplineData, setDisciplineData] = useState([]);
    // const [activeStep, setActiveStep] = useState(1);
    const [scoreMatchData, setScoreMatchData] = useState({
        1: {
            min_degree: scoreData.min_degree
        },
        2: {
            institute_location: scoreData.institute_location,
            institute_attended: scoreData.institute_attended
        },
        3: {
            discipline: scoreData.discipline
        },
        4: {
            average_grade: scoreData.average_grade
        },
        5: {
            min_experience: scoreData.min_experience
        },
        6: {
            title: scoreData.english_level?.title,
            score: scoreData.english_level?.score
        },
        7: {
            tuition_budget: scoreData.tuition_budget
        },
        8: {
            living_cost_budget: scoreData.living_cost_budget
        }
    });
                            ...
                            <div className='score-match-form'>
                                <div data-step="1" className={`${activeStep === 1 ? "" : "d-none"}`}>
                                        ...
                                        <div className="radio-list">
                                            <div className="radio-item">
                                                <input
                                                    ...
                                                    checked={scoreMatchData[1].min_degree === "High school diploma"}
                                                />
                                            ...
                                            <div className="radio-item">
                                                <input
                                                    ...
                                                    onChange={handleDegree}
                                                    checked={scoreMatchData[1].min_degree === "Bachelor's degree"}
                                                />
                                            ...
                                            <div className="radio-item">
                                                <input
                                                    ...
                                                    onChange={handleDegree}
                                                    checked={scoreMatchData[1].min_degree === "Master's degree"}
                                                />
                                            ...
                                            <div className="radio-item">
                                                <input
                                                    ...
                                                    value="Ph.D degree"
                                                    onChange={handleDegree}
                                                    checked={scoreMatchData[1].min_degree === "Ph.D degree"}
                                                />
                                    ...
                                    <div className='form-btns'>
                                        <a href='#' style={{...actionBtnStyle, color: "#247ba0"}} onClick={handleScoreSubmit}>Finish </a>
                                    </div>
                                </div>
                                    ...
                                    <div className='form-fields mt-4'>
                                        <div className="form-group">
                                            ...
                                            <select
                                                ...
                                                id="score_state"
                                                value={scoreMatchData[2].institute_location}
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input
                                                className='form-control'
                                                value={scoreMatchData[2].institute_attended}
                                    ...
                                    <div className='form-fields mt-4'>
                                        <div className="form-group">
                                            ...
                                            >
                                                ...
                                                {disciplineData.map((discipline, index) => <option
                                                    key={index}
                                                    value={discipline.id}
                                                    selected={scoreMatchData[3].discipline === discipline.id}
                                                >
                                                    {discipline.name}
                                                </option>)}
                                            </select>
                                    ...
                                    <div className='form-fields mt-4'>
                                        ...
                                        <div className="form-group">
                                            ...
                                            >
                                                ...
                                                {GRADE_GPA.map((grade, index) => <option
                                                    key={index}
                                                    value={grade}
                                                    selected={scoreMatchData[4].average_grade === grade}
                                                >
                                                    {grade} {GRADE_GPA_PERCENTAGE[index]}
                                                </option>)}
                                            </select>
                                        </div>
                                    </div>
                                            ...
                                            <div className="radio-list">
                                                <div className="radio-item">
                                                    <input
                                                        ...
                                                        type="radio"
                                                        value="No experience"
                                                        checked={scoreMatchData[5].min_experience === "No experience"}
                                                ...
                                                <div className="radio-item">
                                                    <input
                                                        ...
                                                        value="1 Year"
                                                        onChange={handleExperience}
                                                        checked={scoreMatchData[5].min_experience === "1 Year"}
                                                    />
                                                ...
                                                <div className="radio-item">
                                                    <input
                                                        ...
                                                        value="2 Year"
                                                        onChange={handleExperience}
                                                        checked={scoreMatchData[5].min_experience === "2 Year"}
                                                    />
                                                ...
                                                <div className="radio-item">
                                                    <input
                                                        name="radio"
                                                        id="degree_exp_three_four"
                                                        type="radio"
                                                        value="3-4 Year"
                                                        onChange={handleExperience}
                                                        checked={scoreMatchData[5].min_experience === "3-4 Year"}
                                                    />
                                                ...
                                                <div className="radio-item">
                                                    <input
                                                        name="radio"
                                                        id="degree_exp_five_plus"
                                                        type="radio"
                                                        value="5+ Year"
                                                        onChange={handleExperience}
                                                        checked={scoreMatchData[5].min_experience === "5+ Year"}
                                                    />
                                    ...
                                    <div className='form-fields mt-4'>
                                        <div className="form-group">
                                            ...
                                            >
                                                ...
                                                {ENGLISH_TEST.map((test, index) => <option
                                                    key={index}
                                                    value={test}
                                                    selected={scoreMatchData[6].title === test}
                                                >
                                                    {test}
                                                </option>)}
                                            </select>
                                    ...
                                    <div className='form-fields mt-4'>
                                        ...
                                        <div className="form-group">
                                            <input
                                                ...
                                                value={scoreMatchData[7].tuition_budget}
                                    ...
                                    <div className='form-fields mt-4'>
                                        ...
                                        <div className="form-group">
                                            <input
                                                className='form-control'
                                                placeholder='Your budget'
                                                value={scoreMatchData[8].living_cost_budget}
